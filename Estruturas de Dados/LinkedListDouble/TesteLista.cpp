...
bool testar_InserirOrdenado()
{
    cout << "INÍCIO: Teste LIS_InserirOrdenado" << endl;
    
    bool resultado = true;
    
    Lista lista = LIS_Criar();
    
    int v[] = {55,66,11,22,99,33,44,77,88,111};
    ...
    for(int i = 0; i < 10; i++)
    {
        ...
        bool inseriu = LIS_InserirOrdenado(lista, valorInserido);
        if( !inseriu )
        {
            cerr << "\tERRO - Teste LIS_InserirOrdenado: não inseriu elemento na lista corretamente." << endl;
            resultado = false;
            break;
        }
        ...
        if( verificada != LIS_OK )
        {
            cerr << "\tERRO - Teste LIS_InserirOrdenado: alguma invariante da lista foi quebrada. Código do erro: " << verificada << endl;
            resultado = false;
            break;
        }
        ...
        if( tamanhoDepois != tamanhoAntes + 1 )
        {
            cerr << "\tERRO - Teste LIS_InserirOrdenado: tamanho da lista não foi incrementado corretamente." << endl;
            resultado = false;
            break;
        }
        ...
        for( No no = lista->cabeca->proximo; no != lista->cauda->anterior; no = no->proximo )
        {
            ...
            {
                cerr << "\tERRO - Teste LIS_InserirOrdenado: lista não está ordenada corretamente." << endl;
                resultado = false;
                break;
            }
        }
    ...
    cout << "FIM: Teste LIS_InserirOdenado" << endl << endl;
...
bool testar_BuscarMF()
{
    cout << "INÍCIO: Teste LIS_BuscarMF" << endl;
    ...
    for(int i = 0; i < 10; i++)
    {
        int valorBuscado = v[9-i];
        
        No noRetornado = LIS_BuscarMF(lista, valorBuscado);
        
        LIS_tpVerificacao verificada = LIS_Verificar(lista);
        if( verificada != LIS_OK )
        {
            cerr << "\tERRO - Teste LIS_BuscarMF: alguma invariante da lista foi quebrada. Código do erro: " << verificada << endl;
            resultado = false;
            break;
        }
        
        int valorRetornado = noRetornado->valor;
        
        if( valorRetornado != valorBuscado )
        {
            cerr << "\tERRO - Teste LIS_BuscarMF: buscou a chave " << valorBuscado << ", mas retornou nó com conteúdo igual a " << valorRetornado << endl;
            resultado = false;
            break;
        }
        
        if( lista->cabeca->proximo != noRetornado )
        {
            cerr << "\tERRO - Teste LIS_BuscarMF: o nó retornado não foi movido para o início da lista." << endl;
            resultado = false;
            break;
        }        
    }
    ...
    for(int i = 0; i < 4; i++)
    {
        ...
        if( indiceRetornado != -1 )
        {
            cerr << "\tERRO - Teste LIS_BuscarMF: buscou chave inexistente e não retornou -1." << endl;
            resultado = false;
            break;
        }
    ...
    cout << "FIM: Teste LIS_BuscarMF" << endl << endl;
    
    return resultado;
}

bool testar_BuscarCF()
{
    cout << "INÍCIO: Teste LIS_BuscarCF" << endl;
    ...
    for(int i = 0; i < 10; i++)
    {
        ...
        No noRetornado = LIS_BuscarCF(lista, valorBuscado);
        
        int valorRetornado = noRetornado->valor;
        
        if( valorRetornado != valorBuscado )
        {
            cerr << "\tERRO - Teste LIS_BuscarCF: buscou a chave " << valorBuscado << ", mas retornou nó com conteúdo igual a " << valorRetornado << endl;
            resultado = false;
            break;
        }
        
        for( No no = lista->cabeca->proximo; no->proximo != lista->cauda; no = no->proximo )
        {
            if( no->contadorAcessos < no->proximo->contadorAcessos )
            {
                cerr << "\tERRO - Teste LIS_BuscarCF: a lista não está ordenada pelo contador de acessos." << endl;
                resultado = false;
                break;
            }
        }
        ...
        if( verificada != LIS_OK )
        {
            cerr << "\tERRO - Teste LIS_BuscarCF: alguma invariante da lista foi quebrada. Código do erro: " << verificada << endl;
            resultado = false;
            break;
        }
    }
    ...
    for(int i = 0; i < 4; i++)
    {
        ...
        if( indiceRetornado != -1 )
        {
            cerr << "\tERRO - Teste LIS_BuscarCF: buscou chave inexistente e não retornou -1." << endl;
            resultado = false;
            break;
        }
